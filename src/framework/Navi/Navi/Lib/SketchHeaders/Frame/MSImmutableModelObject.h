...
@interface MSImmutableModelObject : MSModelObjectCommon
{
...
- (void)enumerateMigrations:(SEL *)arg1 fromVersion:(long long)arg2 toVersion:(long long)arg3 block:(id)arg4;
...
- (id)initWithUnarchiver:(id)arg1 decodeBlock:(id)arg2;
