...
#import "NVGridSemanticItemView.h"

@implementation NVGridSemanticItemView{
    //    NSBox *box;
...
- (instancetype)initWithCoder:(NSCoder *)coder {
    NVGridSemanticItemView *view = [super initWithCoder:coder];
...
-(void)setSpec:(NVGridSpec)borderSpec{
    _spec = borderSpec;
    [self drawStyle];
