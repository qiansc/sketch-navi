...
-(BOOL)filter:(NSDictionary*) specDict {
    ...
    NVWeightSpec spec = [NVWeightSource value:specDict];
...
-(NVWeightSpec)getSpecAt:(NSIndexPath *) indexPath{
    ...
    return [NVWeightSource value: dict];
}
...
//        .nightColor = specDict[@"nightValue"][@"color"],
        ...
        .iosFont = [specDict[@"ios"] doubleValue],
        .androidFont = [specDict[@"android"] doubleValue],
        .h5Font = [specDict[@"h5"] doubleValue],
