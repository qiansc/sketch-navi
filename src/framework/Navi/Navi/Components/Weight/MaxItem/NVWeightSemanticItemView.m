...
#import "NVWeightSemanticItemView.h"
#import "HexColor.h"

@implementation NVWeightSemanticItemView{
    NSTextField *itemTitle;
    NSTextField *itemDesc;
}

- (instancetype)initWithCoder:(NSCoder *)coder {
    NVWeightSemanticItemView *view = [super initWithCoder:coder];
