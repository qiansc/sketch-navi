...
@implementation NVHoriCollectionView {
}

- (void)awakeFromNib {
    [super awakeFromNib];
    self.dataSource = [[NVHoriSource alloc]init];
...
-(void)collectionView:(NSCollectionView *)collectionView willDisplayItem:(NSCollectionViewItem *)item forRepresentedObjectAtIndexPath:(NSIndexPath *)indexPath{
    NVHoriSpec spec = [self.dataSource getSpecAt:indexPath];
    NVHoriCollectionItemView *view = item.view;
